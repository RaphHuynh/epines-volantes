...
import noug from "./../../assets/avatar/noug.png"
...
import guimauve from "./../../assets/avatar/guimauve.png"
    ...
    return (
        <div>
             <div id="Roster" className="flex items-center w-full min-h-screen justify-center">
                <div>
                    <div className="flex items-center justify-center" data-aos="fade" data-aos-duration="2000">
                        <img src={logoRosterEpine} alt="epines volantes" width="100px" className="hidden lg:flex"></img>
                        <h1 className="lg:ml-5 text-4xl text-center lg:text-7xl text-amber-400">Roster 1 : Epines Volantes</h1>
                    </div>
                    <div className="w-full flex items-center justify-center" data-aos="fade" data-aos-duration="2000">
                        <p className="my-5 text-justify mx-16 text-l lg:max-w-3xl lg:text-lg">Voici le Roster 1 de Epines volantes. Actuellement, notre roster est en division {division[0].division} de la MKU. Notre objectif est de remporter le titre de notre division pour devenir une high div.</p>
                    </div>
                    <div className="flex justify-center">
                        <div className="flex flex-wrap justify-center w-4/6">
                            {rosterEpine.map((roster)=>(
                                <div className="bg-black/5 dark:bg-white/5 rounded-lg sm:mx-5 my-5 px-4 hover:bg-blue-400/20 dark:hover:bg-blue-400/10 transition delay-50 py-5" data-aos="fade" data-aos-duration="2000">
                                    ...
                                    <span className="flex items-center justify-center my-2 mx-auto">
                                        ...
                                        {roster.twitch !== "" &&
                                            <a href={roster.twitch} target="_blank" className="ml-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-twitch" viewBox="0 0 16 16 " className="transition delay-75 w-7 fill-violet-700 hover:fill-yellow-400">
            ...
            <div className="flex items-center w-full min-h-screen justify-center mt-10">
                <div>
                    <div className="flex items-center justify-center" data-aos="fade" data-aos-duration="2000">
                        <img src={logoRosterEclair} alt="epines volantes" width="100px" className="hidden lg:flex"></img>
                        <h1 className="lg:ml-5 text-4xl text-center lg:text-7xl text-amber-400">Roster 2 : Eclair Vicieuse</h1>
                    </div>
                    <div className="w-full flex items-center justify-center" data-aos="fade" data-aos-duration="2000">
                        <p className="my-5 text-justify mx-16 text-l lg:max-w-3xl lg:text-lg">Voici le Roster 2 de Epines volantes, l'éclair vicieuse. Pour le moment, notre roster est en division {division[1].division} de la MKU. Nous avons pour but d'essayer de remporter notre division pour monter mais notre premier objectif est dans un premier temps de nous améliorer sur les bases du jeu en équipe.</p>
                    </div>
                    <div className="flex justify-center">
                        <div className="flex flex-wrap justify-center w-4/6">
