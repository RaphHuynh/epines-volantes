...
function Awards(){
    ...
    return (
        <div id="Awards" className="flex items-center w-full min-h-screen justify-center mt-10">
            <div>
                <h1 className="text-7xl text-amber-400 text-center mb-7" data-aos="fade" data-aos-duration="2000">
                    Awards
                </h1>
                ...
                <div className="w-full flex items-center justify-center">
                    <p className="my-5 text-justify max-w-3xl text-lg" data-aos="fade" data-aos-duration="2000">
